...
public class Customer implements Comparable, java.io.Serializable
 {
  ...
  // compareTo method returns 0 if this customer is same as the
  // other customer (parameter of the method), returns a negative integer
  // if this customer is less, and returns a positive integer if this customer
  // is larger.
  public int compareTo(Object other)
   {
       int result;
       if (lastName.equals(((Customer) other).lastName))
         result = firstName.compareTo(((Customer) other).firstName);
       else
         result = lastName.compareTo(((Customer) other).lastName);
